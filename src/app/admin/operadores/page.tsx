    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          {message && (
            <div
              className={`p-4 rounded-xl mb-6 ${message.type === "success" ? "bg-green-50 text-green-800 border border-green-200" : "bg-red-50 text-red-800 border border-red-200"}`}
            >
              {message.text}
            </div>
          )}
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="space-y-1">
                          ...
                          <div
                            className="text-xs text-gray-500 font-mono truncate max-w-50"
                            title={operador._id}
                          >
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 font-mono">
                        {maskCPF(operador.cpf || operador.matricula || "") ||
                          "Não informado"}
                      </td>
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${operador.ativo ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                        >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() =>
                              gerarQRCode(operador._id, operador.nome)
                            }
        ...
        <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-2xl">
          <h3 className="text-lg font-semibold text-blue-900 mb-3">
            Como funciona o login dos operadores?
          </h3>
          <ul className="space-y-2 text-sm text-blue-800">
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-1 mr-3 shrink-0"></span>
              Cada operador recebe um{" "}
              <strong className="font-mono">ID único</strong> gerado
              automaticamente pelo Banco de Dados.
            </li>
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-1 mr-3 shrink-0"></span>
              Para fazer login, o operador deve digitar ou escanear este ID na
              tela de expedição
            </li>
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-1 mr-3 shrink-0"></span>
              Você pode copiar o ID de cada operador usando o botão "👁️" na
              lista acima
            </li>
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-1 mr-3 shrink-0"></span>
              Os primeiros 8 caracteres do ID são mostrados na tabela para fácil
              identificação
            </li>
          </ul>
        </div>
